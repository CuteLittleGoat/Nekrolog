...
## Prompt użytkownika
"Zmodyfikuj plik Analizy/analiza_struktury_trzech_kolekcji_firebase.md
Chcę, żebyś zawarł tam PEŁNĄ strukturę każdej z kolekcji.
Wypisz wszystkie dostępne pole wraz z opisem jaki to typ danych.
Dodatkowo zapisz strukturę w formie drzewka.
Zawrzyj też tam konfigurację:
...
Plik Analizy/analiza_struktury_trzech_kolekcji_firebase.md ma być podstawą do stworzenia zupełnie nowego projektu wykorzystującego istniejące kolekcje i konfigurację. W dokumentacji nie odnoś się do istniejących rozwiazań, ponieważ wszystko zostanie stworzone od zera."
