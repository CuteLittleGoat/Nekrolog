...
3. W aplikacji istnieje plik test.json - daje on dostęp do Firebase. Możesz w pełni modyfikować kolekcje Nekrologi_config, Nekrologi_refresh_jobs i Nekrologi_snapshots pozostałe są do innego projektu i nie możesz nic tam zmieniać
