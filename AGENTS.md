...
3. W aplikacji istnieje plik test.json - daje on dostęp do Firebase. Możesz w pełni modyfikować kolekcje Nekrolog_config, Nekrolog_refresh_jobs i Nekrolog_snapshots pozostałe są do innego projektu i nie możesz nic tam zmieniać
